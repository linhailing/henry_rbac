...
<html lang="<?= Yii::$app->language ?>">
  ...
  <body class="page-header-fixed page-quick-sidebar-over-content page-sidebar-closed-hide-logo page-container-bg-solid">
	...
	<div class="page-logo">
	  <a href="index.html">
	    <img src="<?=urlhelper::buildurl('/vendor/admin/layout/img/logo.png') ?>" alt="logo" class="logo-default"/>
	  </a>
	  ...
	  <ul class="nav navbar-nav pull-right">
		...
		<li>
		  <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
			...
			<span class="photo">
			  <img src="<?=urlhelper::buildurl('vendor/admin/layout3/img/avatar2.jpg')?>" class="img-circle" alt="">
			</span>
			<span class="subject">
			  <span class="from">
			    Lisa Wong </span>
		    ...
		    <li>
		      <a href="inbox.html?a=view">
			<span class="photo">
			  <img src="<?=urlhelper::buildurl('vendor/admin/layout3/img/avatar3.jpg')?>" class="img-circle" alt="">
			</span>
			<span class="subject">
			  <span class="from">
			    Richard Doe </span>
		    ...
		    <li>
		      <a href="inbox.html?a=view">
			<span class="photo">
			  <img src="<?=urlhelper::buildurl('vendor/admin/layout3/img/avatar1.jpg')?>" class="img-circle" alt="">
			</span>
			<span class="subject">
			  <span class="from">
			    Bob Nilson </span>
	    ...
	    <li class="dropdown dropdown-user">
	      <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
		<img alt="" class="img-circle" src="<?=urlhelper::buildurl('vendor/admin/layout/img/avatar3_small.jpg')?>"/>
	...
	2017 &copy; henry by keenthemes. <a href="#" title="Purchase Metronic just for 27$ and get lifetime updates for free" target="_blank">HENRY Metronic!</a>
      </div>
